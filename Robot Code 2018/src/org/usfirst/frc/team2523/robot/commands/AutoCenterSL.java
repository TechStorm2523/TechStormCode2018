...
public class AutoCenterSL extends CommandGroup {
    ...
    public AutoCenterSL() {
        ...
        // arm.
    		...
    		System.out.println("Did First Go");
    		addSequential(new TurnAngle(45));
    		
    		System.out.println("Did First Turn");
    		addSequential(new GoDistance(72, .5));
    		
    		System.out.println("Did Second Go");
    		addSequential(new TurnAngle(-45));
    		
    		System.out.println("Did Second Turn");
    		addSequential(new GoDistance(57, .5));
    		
    		System.out.println("Did Last Go");
